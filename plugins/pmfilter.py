from utils import get_size, group_setting_buttons, get_poster, get_posterx, temp, get_settings, save_group_settings, get_cap, imdb, is_check_admin, extract_request_content, log_error, clean_filename, generate_season_variations, clean_search_text
import tracemalloc
...
async def give_filter(client, message):
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        await message.reply_text(
            ...
            f"<b>‼️ ᴛʜɪꜱ ɪꜱ ᴀ <u>sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ</u> sᴏ ᴛʜᴀᴛ ʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ғɪʟᴇs ғʀᴏᴍ ʜᴇʀᴇ...\n\n"
            f"📝 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ : 👇</b>",
        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    ...
                    "<blockquote>"
                    "আপনি শুধুমাত্র আমাদের 𝑴𝒐𝒗𝒊𝒆 𝑮𝒓𝒐𝒖𝒑-এই 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 করতে পারবেন।"
                    "আপনার 𝑫𝒊𝒓𝒆𝒄𝒕 𝑩𝒐𝒕-এ 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 করার 𝑷𝒆𝒓𝒎𝒊𝒔𝒔𝒊𝒐𝒏 নেই। অনুগ্রহ করে নিচে দেওয়া 𝑹𝑬𝑸𝑼𝑬𝑺𝑻 𝑯𝑬𝑹𝑬 বাটনে ক্লিক করে আমাদের 𝑴𝒐𝒗𝒊𝒆 𝑮𝒓𝒐𝒖𝒑-এ 𝑱𝒐𝒊𝒏 করুন এবং সেখানে আপনার পছন্দের 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 করুন।"
                    "</blockquote></b>"
